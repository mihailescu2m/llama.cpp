...
void ggml_metal_encoder_set_threadgroup_memory_size(ggml_metal_encoder_t encoder, size_t size, int idx) {
    // Metal requires threadgroup memory lengths to be 16-byte aligned; an unaligned length is
    // undefined behaviour and shows up as corrupt results on some kernels. ref: PR #27879
